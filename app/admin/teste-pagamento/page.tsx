    ...
    <div className="min-h-screen flex items-center justify-center bg-secondary/30 px-4">
      <div className="w-full max-w-md border border-border bg-background p-8">
        ...
        <p className="mt-6 text-sm font-light text-muted-foreground">
          Cria um pagamento real de valor simbólico, <strong>sem frete</strong> (retirada),
          no nome de <strong>{session?.user?.email ?? '...'}</strong>. Depois de pagar, o pedido
          deve aparecer como pago no Painel de Pedidos. Use &quot;Negar&quot; lá para testar o reembolso.
        </p>
